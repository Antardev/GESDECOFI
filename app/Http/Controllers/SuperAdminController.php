...
class SuperAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $valides = Stagiaire::where('validated', 1)->count();
        $non_valides = $total - $valides;
        $parPays = Stagiaire::selectRaw('country, COUNT(*) as total')
            ->groupBy('country')->pluck('total', 'country');
        return view('superadmin.dashboard', compact('total', 'valides', 'non_valides', 'parPays'));
