...
// Il s'agit des routes du stagiaire non verifié
    ...
    Route::middleware(['auth', 'verified', 'cnverified', 'assistant_complete'])->controller(ControleurController::class)->group(function () {
        ...
        Route::get('/CN/stagiaires', 'getStagiairesCN')->name('CN.stagiaires');
    ...
    Route::middleware(['auth', 'verified', 'crverified'])->controller(ControleurController::class)->group(function () {
        ...
        Route::post('/subdomains/deactivate/{id}', 'desactive_sous_domain')->name('subdomains.deactivate');
        Route::post('subdomains/activate/{id}', 'activate_sous_domain')->name('subdomains.activate');
        ...
        Route::post('/add_sous_categorie', 'save_subcategorie')->name('save_sous_categorie');
    ...
    Route::middleware(['auth', 'verified', 'superadmin'])->controller(SuperAdminController::class)->group(function () {
        ...
        Route::get('/superadmin/stagiaires/dashboard', 'index')->name('superadmin.dashboard.stagiaires');
