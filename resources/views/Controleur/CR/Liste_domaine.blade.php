                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <form action="{{ $subdomain->active ? route('subdomains.deactivate', $subdomain->id) : route('subdomains.activate', $subdomain->id) }}" 
                                                                  method="POST" 
                                                                ...
                                                                <button type="submit" 
                                                                        ...
                                                                        data-id="{{ $subdomain->id }}" 
                                                                        data-active="{{ $subdomain->active ? 'true' : 'false' }}">
        ...
        button.addEventListener('click', async function(e) {
            ...
            if (confirmation.isConfirmed) {
                ...
                try {
                    ...
                    this.innerHTML = `<i class="bi ${isActive ? 'bi-check-circle' : 'bi-slash-circle'}"></i> ${isActive ? 'Activer' : 'Désactiver'}`;
