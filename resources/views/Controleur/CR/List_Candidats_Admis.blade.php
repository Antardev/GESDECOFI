...
<div class="container py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-white text-black d-flex justify-content-between align-items-center">
            <h2 class="text-center mb-4">Liste des candidats admis</h2>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '.candidat-checkbox', function() {
            ...
            // Affiche ou cache le bouton selon l'état des cases à cocher
        ...
        /*
            $('#submitButton').click(function() {
                ...
                if (selectedIds.length > 0) {
                    $.post('{{ route("CR.passercandidats") }}', { ids: selectedIds })
