            ...
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="btn-group ms-3" > <!-- Utilisez ms-3 pour un espacement -->
                            <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                Mes Tableaux
                            </button>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('Tableau1')}}">Fiche semestrielle des heures d'intervention</a></li>
                                <li><a class="dropdown-item" href="{{route('Tableau2')}}">Synthèse des formations </a></li>
                                <li><a class="dropdown-item" href="{{route('Tableau3')}}">Récapitulatif du Volume Horaire Effectué Durant le Stage</a></li>
                                <li><a class="dropdown-item" href="{{route('Tableau4')}}">Récapitulatif des Heures par Activité</a></li>
                                <li><a class="dropdown-item" href="{{route('Tableau5')}}">Récapitulatif des Modules et Observations</a></li>
