            ...
            <form action="{{ route('stagiaire.edit') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                ...
                <div id="user-info" style="display: {{ $errors->any() ? 'block' : 'none' }};">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('affiliation_order') is-invalid @enderror" id="affiliation_order" name="affiliation_order" value="{{ old('affiliation_order') }}" readonly>
                    ...
                    <div class="mb-3">
                        <label for="contrat" class="form-label">Contrat de travail <span class="text-small text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="prenom_maitre" class="form-label">{{ __('sign_stage.prenom_maitre') }} <span class="text-small text-danger">*</span></label>
